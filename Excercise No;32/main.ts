...
let current_users:string[] =["areeba","Rimsha","Dua","Hira","Rida"]

//Array of new users:
let new_users:string[]=["Meryam","Qurat","dua","Areeba","Fiza"]
...
new_users.forEach(welcome =>{
    ...
    else {console.log(`The username "${welcome}" is available`)}
